...
const provider = new Web3.providers.HttpProvider("http://127.0.0.1:8545");//port specified during start of geth node. this can vary
const web3 = new Web3(provider);

// Load the deployed contract ABI and address
const contractABI = require('./build/contracts/DataStorage_gNb1.json').abi;
const contractAddress = '0xeB293cb2aF1d154E7038C811286897bA5d971A4D';
